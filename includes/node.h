...
public:
    ...
    //x可能的移动步长
    float dx[3] = { 0.7068582,   0.7031850,   0.7031850 };//{ 0.7068582,   0.705224,   0.705224 };
    //y可能的移动步长
    float dy[3] = { 0,        -0.0622937,     0.0622937 };//{ 0,        -0.0415893,     0.0415893 };
    //t可能的移动步长
    float dt[3] = { 0,        -0.17671455,     0.17671455 };//{ 0,        -0.1178097,     0.1178097 };//0.1178097,    -0.1178097 };
    //父节点
    Node3D* pred;
    //父节点Idx
    int pIdx;
